...
The most immediately helpful way you can benefit this project is by using the Riak Spark Connector in your own application and providing examples to the community detailing how you use it. Open an issue in this repository and we may be able to use your sample code in the `RiakClientExamples` project.

## How-to contribute to the Riak Spark Connector
