...
def test_con(spark_context, docker_cli, riak_client, sql_context):
	_test_connection(spark_context, docker_cli, riak_client, sql_context)

###### KV Tests #######

def test_kv_write(spark_context, docker_cli, riak_client, sql_context):
	_test_spark_rdd_write_kv(10, spark_context, docker_cli, riak_client, sql_context)

def test_kv_query_all(spark_context, docker_cli, riak_client, sql_context):
	_test_spark_rdd_kv_read_query_all(10, spark_context, docker_cli, riak_client, sql_context)

def test_kv_query_bucket_keys(spark_context, docker_cli, riak_client, sql_context):
	_test_spark_rdd_kv_read_query_bucket_keys(10, spark_context, docker_cli, riak_client, sql_context)

def test_kv_query_2i_keys(spark_context, docker_cli, riak_client, sql_context):
	_test_spark_rdd_kv_read_query_2i_keys(10, spark_context, docker_cli, riak_client, sql_context)

def test_kv_query_2i_range(spark_context, docker_cli, riak_client, sql_context):
	_test_spark_rdd_kv_read_query2iRange(10, spark_context, docker_cli, riak_client, sql_context)

def test_kv_query_partition_by_2i_range(spark_context, docker_cli, riak_client, sql_context):
	_test_spark_rdd_kv_read_partition_by_2i_range(10, spark_context, docker_cli, riak_client, sql_context)

###### TS Tests #######

def test_ts_df_write_use_timestamp(spark_context, docker_cli, riak_client, sql_context):
	_test_spark_df_ts_write_use_timestamp(10, 5, spark_context, docker_cli, riak_client, sql_context)

def test_ts_df_write_use_long(spark_context, docker_cli, riak_client, sql_context):
	_test_spark_df_ts_write_use_long(10, 5, spark_context, docker_cli, riak_client, sql_context)

def test_ts_df_read_use_timestamp(spark_context, docker_cli, riak_client, sql_context):
	_test_spark_df_ts_read_use_timestamp(10, 5, spark_context, docker_cli, riak_client, sql_context)

def test_ts_df_read_use_long(spark_context, docker_cli, riak_client, sql_context):
	_test_spark_df_ts_read_use_long(10, 5, spark_context, docker_cli, riak_client, sql_context)

def test_ts_df_read_use_timestamp_ts_quantum(spark_context, docker_cli, riak_client, sql_context):
	_test_spark_df_ts_read_use_timestamp_ts_quantum(10, 5, spark_context, docker_cli, riak_client, sql_context)

def test_ts_df_read_use_long_ts_quantum(spark_context, docker_cli, riak_client, sql_context):
	_test_spark_df_ts_read_use_long_ts_quantum(10, 5, spark_context, docker_cli, riak_client, sql_context)

def test_ts_df_range_query_input_split_count_use_timestamp(spark_context, docker_cli, riak_client, sql_context):
	_test_spark_df_ts_range_query_input_split_count_use_timestamp(10, 50, 1, spark_context, docker_cli, riak_client, sql_context)

def test_ts_df_range_query_input_split_count_use_long(spark_context, docker_cli, riak_client, sql_context):
	_test_spark_df_ts_range_query_input_split_count_use_long(10, 50, 1, spark_context, docker_cli, riak_client, sql_context)

def test_ts_df_range_query_input_split_count_use_timestamp_ts_quantum(spark_context, docker_cli, riak_client, sql_context):
	_test_spark_df_ts_range_query_input_split_count_use_timestamp_ts_quantum(10, 50, 1, spark_context, docker_cli, riak_client, sql_context)

def test_ts_df_range_query_input_split_count_use_long_ts_quantum(spark_context, docker_cli, riak_client, sql_context):
	_test_spark_df_ts_range_query_input_split_count_use_long_ts_quantum(10, 50, 1, spark_context, docker_cli, riak_client, sql_context)
